...
CPU scheduling policies is using the simple fixed-priority scheduling by Linux-RTXG similar to Linux's \textbf{SCHED\_FIFO} that difference is the presence or absence of the job management.
