...
GPU scheduler is required to receive notify the completion of GPU kernel, for selecton of next executing GPU kernel.
...
The Interrupt-driven method can be synchronized for each kernel, it is required to modificate the kernel or the device driver's ISR.
